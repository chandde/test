...
var react_hot_loader = __webpack_require__(4);

// EXTERNAL MODULE: ./node_modules/lodash/lodash.js
var lodash = __webpack_require__(5);
var lodash_default = /*#__PURE__*/__webpack_require__.n(lodash);

// CONCATENATED MODULE: ./src/shared-code-box.js



class shared_code_box_SharedCodeBox extends react_default.a.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  createWsConnection() {
    ...
    this.ws = new WebSocket(`ws://${window.location.host}:4000/wss/${id}`); // if (!this.ws) {
    //   this.setState({
    ...
    this.ws.onerror = lodash_default.a.debounce(err => {
      console.log('this.ws.onerror');
      this.setState({
        statusText: JSON.stringify(err)
      });
    }, 500);
    this.ws.onclose = lodash_default.a.debounce(() => {
      console.log('this.ws.onclose'); // auto reconnect on close
...
react_dom_default.a.render( /*#__PURE__*/react_default.a.createElement(react_hot_loader["AppContainer"], null, /*#__PURE__*/react_default.a.createElement(shared_code_box_SharedCodeBox, null)), document.querySelector('.app-root'));
