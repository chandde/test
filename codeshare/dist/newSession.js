...
class Dialog extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
    this.state = {
      text: undefined,
    ...
    this.ws.onopen = () => {
      const statusel = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.wsConnectionStatusDiv');
  ...
  componentDidMount() {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.inputTextArea').height(window.innerHeight - 80);
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.inputTextArea').width(window.innerWidth - 80);
  }
  ...
  styleChanged(e) {
    ...
    if (languageMap[e.target.innerText] !== this.state.style) {
      this.setState({
        style: languageMap[e.target.innerText]
      });
    }
  }
  ...
  render() {
    ...
    }, "connecting..."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
...
*/
var aa=__webpack_require__(0),n=__webpack_require__(2),r=__webpack_require__(8);function u(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(u(227));
...
/* harmony import */ var react_hot_loader__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4);
...
/* harmony import */ var _dialog__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5);
